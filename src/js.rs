...
//!
//! Taskrunner began as a TypeScript program, and the records it wrote share the
//! archive with ours, so the index and every rendered view keep its exact
//! results. A handful of its operations differ from Rust's at the edges:
