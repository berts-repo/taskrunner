...
//! socket is served elsewhere, so a long backfill never delays it. That is
//! what the TypeScript sweeper's 50 ms yield protected, by other means.
...
/// format, shared with the TypeScript daemon.
